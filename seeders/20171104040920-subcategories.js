  ...
  up: (queryInterface, Sequelize) => {
    ...
    return queryInterface.bulkInsert('SubCategories', [
      ...
      //Category 4
      {
        ...
        subcategory_name: 'Christmas Decorating',
      ...
      // Category 5
      {
        subcategory_name: 'Troubleshooting',
        description: 'Don\'t know why your printer isn\'t printing? We\'ll troubleshoot that for you',
        CategoryId: 5,
        createdAt: new Date(),
        updatedAt: new Date()
      }, {
        subcategory_name: 'Website Building',
        description: 'Want to create a website for that new baking company you\'ve always dreamed of? No problem!',
        CategoryId: 5,
        createdAt: new Date(),
        updatedAt: new Date()
      }, {
        subcategory_name: 'Media',
        description: 'We\'ll edit your photos and videos so that all your friends will all be going "Ooooooo"',
        CategoryId: 5,
        createdAt: new Date(),
        updatedAt: new Date()
      }, {
      ...
      {
        subcategory_name: 'Miscellaneous',
        description: 'Services that did not fit any category AND subcategory perfectly',
        CategoryId: 6,
        createdAt: new Date(),
        updatedAt: new Date()
      }
